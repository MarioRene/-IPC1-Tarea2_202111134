...
public class login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String contras[] = new String[5];
        String visualPass, visualUse;
        
        
        usuario [0] = "Mario Rene Merida Taracena";
        contras [0] = "202111134";
        
        if (user.isEmpty() || pass.isEmpty()){
            JOptionPane.showMessageDialog(null, "...Alguno de los campos esta vacio...");
        }else{
            if (user.equals(usuario [0]) && pass.equals(contras [0])){
                this.dispose();
                JOptionPane.showMessageDialog(null, "Bienvenido " + usuario [0] + " con carnet " + contras [0]);
            }else{
                JOptionPane.showMessageDialog(null, "...Usuatio y/o contraseña incorrectos...");
            }
        }
